...
import { Dict, Mode, ZOOM, UIRenderProps, SchemaForUI, BasePdf, Schema, Plugin, UIOptions } from '@pmee/common';
...
const Renderer = (props: RendererProps) => {
  ...
  if (!plugin || !plugin.ui) {
    console.error(`[@pmee/ui] Renderer for type ${schema.type} not found. 
