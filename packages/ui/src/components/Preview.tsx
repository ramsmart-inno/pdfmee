...
import { Template, SchemaForUI, PreviewProps, Size, getDynamicTemplate, replacePlaceholders } from '@pmee/common';
import { getDynamicHeightsForTable } from '@pmee/schemas/utils';
...
const Preview = ({
  ...
  const init = (template: Template) => {
    ...
    getDynamicTemplate({
      ...
      .catch((err) => console.error(`[@pmee/ui] `, err));
  };
