...
import type { ChangeSchemaItem, Dict, SchemaForUI, PropPanelWidgetProps, PropPanelSchema } from '@pmee/common';
...
const DetailView = (props: DetailViewProps) => {
  ...
  if (!activePropPanelSchema) {
    console.error(`[@pmee/ui] No propPanel.schema for ${activeSchema.type}.
