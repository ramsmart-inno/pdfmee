  ...
  test('fail test: no fallback font', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] fallback flag is not found in font. true fallback flag must be only one.
Check this document: https://pdfme.com/docs/custom-fonts#about-font-type`
  ...
  test('fail test: too many fallback font', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] 2 fallback flags found in font. true fallback flag must be only one.
Check this document: https://pdfme.com/docs/custom-fonts#about-font-type`
      );
    }
  });
  ...
  test('fail test: fontName in Schemas not found in font(single)', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] SauceHanSansJP2 of template.schemas is not found in font.
Check this document: https://pdfme.com/docs/custom-fonts`
  ...
  test('fail test: fontName in Schemas not found in font(single)', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] SauceHanSansJP2,SauceHanSerifJP2 of template.schemas is not found in font.
Check this document: https://pdfme.com/docs/custom-fonts`
      );
    }
  });
...
describe('checkPlugins test', () => {
  ...
  test('fail test: type in Schemas not found in plugins(single)', () => {
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] fail of template.schemas is not found in plugins.`
      );
    }
  });
  test('fail test: type in Schemas not found in plugins(multiple)', () => {
    try {
      ...
      expect(e.message).toEqual(
        `[@pmee/common] fail,fail2 of template.schemas is not found in plugins.`
      );
    }
  });
});
