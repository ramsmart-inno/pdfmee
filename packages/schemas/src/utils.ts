...
import { Schema, mm2pt, Mode, isHexValid, ColorType } from '@pmee/common';
...
export const readFile = (input: File | FileList | null): Promise<string | ArrayBuffer> =>
  new Promise((resolve, reject) => {
    ...
    fileReader.onerror = (e) => {
      reject(new Error('[@pmee/schemas] File reading failed'));
    };
    ...
    if (file) {
      ...
      reject(new Error('[@pmee/schemas] No files provided'));
    }
  });
